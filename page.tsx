...
async function login() {
  ...
  async function runBalanceLookup() {
    try {
      ...
      setBalanceResult({
        success: false,
        message: err?.message || "Balance lookup failed",
      });
      ...
      <div style={pageStyle}>
        <div style={loginCardStyle}>
          ...
          >
            ...
            <div>
              <h1 style={{ margin: 0, fontSize: 28 }}>Protected Admin Login v3</h1>
          ...
          <div style={{ display: "grid", gap: 14 }}>
            ...
            <button style={buttonStyle} onClick={login} disabled={loading}>
              {loading ? "Logging in v3..." : "Log In v3"}           </button>
            ...
            <div style={{ display: "grid", gap: 18 }}>
              <section style={sectionStyle}>
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      setCreateUser((s) => ({ ...s, name: e.target.value }))
                    }
                    style={inputStyle}
                  />
                  <input
                    ...
                    onChange={(e) =>
                      setCreateUser((s) => ({ ...s, email: e.target.value }))
                    }
                    style={inputStyle}
                  />
                </div>
                <button
                  ...
                  onClick={() =>
                    runAction(
                      `/create-user?name=${encodeURIComponent(
                        createUser.name
                      )}&email=${encodeURIComponent(createUser.email)}`
                    )
                  }
                >
                  Create User
              ...
              <section style={sectionStyle}>
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      setFundWallet((s) => ({ ...s, user_id: e.target.value }))
                    }
                    style={inputStyle}
                  />
                  <input
                    ...
                    onChange={(e) =>
                      setFundWallet((s) => ({ ...s, amount: e.target.value }))
                    }
                    style={inputStyle}
                  />
                  <input
                ...
                <button
                  ...
                  onClick={() =>
                    runAction(
                      `/fund-wallet?user_id=${encodeURIComponent(
                        fundWallet.user_id
              ...
              <section style={sectionStyle}>
                ...
                <button
                  ...
                  onClick={() =>
                    runAction(
                      `/transfer?from_user_id=${encodeURIComponent(
                        transfer.from_user_id
                      )}&to_user_id=${encodeURIComponent(
                        transfer.to_user_id
                      )}&amount=${encodeURIComponent(
                        transfer.amount
                      )}&description=${encodeURIComponent(transfer.description)}`
                    )
                  }
                >
                  Transfer Funds
              ...
              {totalAuditPages > 7 && (
                <button
                  ...
                  style={{
                    ...pageNumberStyle,
                    background:
                      safeAuditPage === totalAuditPages ? "#111827" : "white",
